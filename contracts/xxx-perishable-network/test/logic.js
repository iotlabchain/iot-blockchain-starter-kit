...
describe('#' + namespace, () => {
    ...
    const growerCardName = 'grow1';
    const importerCardName = 'import1';
    ...
    beforeEach(async () => {
        ...
        const shipper = factory.newResource(namespace, participantType, 'shipper@email.com');
        shipper.address = '123 Street';
        shipper.accountBalance = 100.00;

        const grower = factory.newResource(namespace, participantType, 'grower@email.com');
        grower.address = '123 Boulevard';
        grower.accountBalance = 200.00;

        const importer = factory.newResource(namespace, participantType, 'importer@email.com');
        importer.address = '123 Broadway';
        importer.accountBalance = 500.00;
        participantRegistry.addAll([shipper, grower, importer]);

        const assetRegistry = await businessNetworkConnection.getAssetRegistry(assetNS);
        // Create the assets.
        const asset1 = factory.newResource(namespace, assetType, 'shipment');
        asset1.owner = factory.newRelationship(namespace, participantType, 'shipper@email.com');
        asset1.value = '10';
